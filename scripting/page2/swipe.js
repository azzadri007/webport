...
/* Click on R2 and all the pannels slide up and the progress bar (side pannel) appears 
      ...
      $(document).on('click', '.bar_R2', function () {
        ...
        $("body").delay(1100).queue(function (next) { $(this).css({'overflow-y': 'visible'});next(); });
      });
      ...
      $(document).on('click', '#return_Progress', function () {
        ...
        $(".bar_L1").delay(800).animate({'margin-left':"-669.34px", 'top':"50px"}, 1200);
        ...
        $("#html, body").delay(2000).animate({ scrollTop: 0 }, 1500);
      });
